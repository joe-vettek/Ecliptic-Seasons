package cloud.lemonslice.client.color.season;

import cloud.lemonslice.helper.ColorHelper;
import net.minecraft.world.level.FoliageColor;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.api.distmarker.OnlyIn;

@OnlyIn(Dist.CLIENT)
public enum OldSolarTermColors
{
    // Spring Solar Terms
    ...
    OldSolarTermColors(int mixColorIn, float alpha, int birchColor, float birchAlpha)
    {
        this.mixColorIn = mixColorIn;
        this.alpha = alpha;
        this.birchColor = ColorHelper.simplyMixColor(birchColor, birchAlpha, FoliageColor.getBirchColor(), 1.0F - birchAlpha);
    }

    OldSolarTermColors(int mixColorIn, float alpha)
    {
        this.mixColorIn = mixColorIn;
        this.alpha = alpha;
    ...
    public static OldSolarTermColors get(int index)
    {
        return values()[index];
    }
